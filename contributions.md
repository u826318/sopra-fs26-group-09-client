...
| **[maxim451]** | [29.03.2026]   | [28ca2e07baed952eef838f450b3c75fa69792efe] | [Implemented backend persistence for barcode-based product addition: created PantryItem entity and repository to store product metadata (barcode, name, calories, timestamp) returned from OpenFoodFacts API.] | [Supports the barcode lookup user story (#4) by enabling confirmed products to be persisted and later displayed in the pantry view., #4 can not be implemented without this part] | 
|                    | [29.03.2026]   | [69a53c475d91dfeb5b773fd6a6e5b25e3a5f43f1] | [Implemented backend consumption tracking: introduced ConsumptionLog entity and repository to persist consumption events with quantity, calories, and timestamp.] | [Supports the consume item user story (#7) by enabling accurate tracking of consumed portions and ensuring correct calorie accounting. Again without resloving this issue that user story can not be done] |
                     | [29.03.2026]   | [ee0c423a1b3037ea240fb59e71b1b5c7d52e0e79] | [Implemented core calorie aggregation logic in PantryService to compute total pantry calories (sum of kcalPerPackage × count) together with simple unit test] | [Supports the pantry overview user story (#8) by enabling calculation of total calorie inventory displayed to users.] |
