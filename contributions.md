...
|                    | 12.04.2026   | [0cd9e04](https://github.com/u826318/sopra-fs26-group-09-server/commit/0cd9e04) | #2 Connect add form to REST API
#17 Build "Add to pantry" form with quantity and unit input | Added the households pantry page (households/[id]/page) on client side, Allowing adding items to the pantry from open food facts API search result along with quantity and calories per package. Total calories inside pantry is now also displayed.  |
